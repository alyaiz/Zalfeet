  ...
  $(function() {
    ...
    if ($("#sales-chart").length) {
      ...
      var SalesChart = new Chart(SalesChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Jan 24", "Feb 24", "Mar 24", "Apr 24", "May 24", "Jun 24", "Jul 24", "Agu 24", "Sep 24", "Okt 24", "Nov 24", "Des 24"],
          datasets: [{
              label: 'Rooms Booking',
              data: [51, 43, 64, 67, 96, 67, 75, 68, 43, 64, 67, 96],
              backgroundColor: '#98BDFF'
            },
            {
              label: 'Vehicles Booking',
              data: [45, 65, 47, 76, 56, 76, 45, 59, 45, 65, 47, 76],
